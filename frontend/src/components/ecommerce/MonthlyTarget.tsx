...
export default function MonthlyTarget({ data }: Props) {
  ...
  return (
    <div className='rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-700 dark:bg-gray-800/50'>
      <div className='px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6'>
        ...
        <p className='mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base'>
          {todayRevenue > 0
            ? `You earned ${formatCurrency(todayRevenue)} today. Keep up the good work!`
